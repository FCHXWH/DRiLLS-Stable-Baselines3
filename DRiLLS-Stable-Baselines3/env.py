...
class LogicSynEnv(gym.Env):
    ...
    def run_command(self,command):
        if not os.path.exists(episodes_dir+'\\'+str(self.episode_num)):
            os.makedirs(episodes_dir+'\\'+str(self.episode_num));
        output_design_file = os.path.join(episodes_dir,str(self.episode_num),str(self.step_num) + '.v');
        output_design_file_mapped = os.path.join(episodes_dir,str(self.episode_num),str(self.step_num) + '-mapped.v');
        ...
        try:
            ...
            self.log_inform = 'lut_6_num='+str(self.lut_6)+', lut_6_level='+str(self.levels);
